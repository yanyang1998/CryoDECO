...
def print_ctf_params(params,accelerator=None):
    assert len(params) == 9
    if accelerator is None:
        ...
        accelerator.print('Image size (pix)  : {}'.format(int(params[0])))
        accelerator.print('A/pix             : {}'.format(params[1]))
        accelerator.print('DefocusU (A)      : {}'.format(params[2]))
        accelerator.print('DefocusV (A)      : {}'.format(params[3]))
        accelerator.print('Dfang (deg)       : {}'.format(params[4]))
        accelerator.print('voltage (kV)      : {}'.format(params[5]))
        accelerator.print('cs (mm)           : {}'.format(params[6]))
        accelerator.print('w                 : {}'.format(params[7]))
        accelerator.print('Phase shift (deg) : {}'.format(params[8]))
...
def load_ctf_for_training(resolution, ctf_params_pkl,accelerator):
    ...
    ctf_params[:, 1] = a_pix
    print_ctf_params(ctf_params[0],accelerator)
